...
import buliding_image from '../assets/cgpsc_new_building.png'
        ...
        <div className="bg-white p-6 rounded-xl shadow">
          <div className="flex items-start justify-between gap-6">
            <div>
              ...
              <div className="flex flex-col items-center justify-center min-h bg-gradient-to-b from-cbg-50 to-white p-6">
                <h1 className="text-4xl font-bold text-cgb-900 mb-6 text-center">
                  छत्तीसगढ़ लोक सेवा आयोग
                </h1>
                <img
                  src={buliding_image}
                  alt="CGPSC Building"
                  className="rounded-2xl shadow-2xl w-full max-w-5xl object-cover border-4 border-cbg-200"
                />
                <p className="mt-6 text-lg text-gray-700 text-center max-w-3xl">
                  Welcome to the official website of the Chhattisgarh Public Service Commission.
                </p>
              </div>
